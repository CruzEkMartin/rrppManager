...
@section('content')
    ...
    @if (Auth::check() && Auth::user()->permiso == 0)
        <form action="{{ route('Sectores.Guardar') }}" method="POST">
            @csrf
            ...
            <div class="card">
                <h4 class="card-header">Nuevo Sector</h4>
                <div class="card-body">
                    <br>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                            ...
                            onkeyup="mayusculas(this);" aria-label="Nombre del sector" aria-describedby="lblNombre">
                ...
                <div class="card-footer">
                    <div class="col-md-6 col-lg-4 col-xl-3 btn-toolbar justify-content-around " role="toolbar">
                        <div class="btn-group mr-2" role="group">
                            <a href="{{ route('Sectores.Index') }}" class="btn btn-secondary"><i
