            ...
            <div class="card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="email" id="email" name="email" value="{{ $usuario->email }}"
                        class="form-control  @error('email') is-invalid @enderror" aria-label="Email" readonly aria-describedby="lblEmail" required>
                    ...
                    <div class="col-md-12">
                        <div class="input-group mb-3 align-items-center">
                            ...
                            <div class="form-inline">
                                <input type="radio" name="radio" id="radio1" value="0"  @if ($usuario->permiso == 0) checked @endif/>
                                <label class="radio ml-3" for="radio1">ADMINISTRADOR</label>
                                <input type="radio" name="radio" id="radio2" value="1"  @if ($usuario->permiso == 1) checked @endif/> <label
